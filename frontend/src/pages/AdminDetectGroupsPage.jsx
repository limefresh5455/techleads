...
import { adminDetectGroups } from '../adminApi'
...
export default function AdminDetectGroupsPage() {
  ...
  const handleDelete = async (id) => {
    if (!window.confirm('Are you sure you want to delete this group? All nested tags will be deleted.')) return
    try {
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-sm">
            ...
            <tbody className="divide-y divide-border">
              ...
              {groups.length === 0 && (
                <tr>
                  <td colSpan="4" className="p-8 text-center text-muted">No Detect Groups found.</td>
                </tr>
              )}
            </tbody>
          </table>

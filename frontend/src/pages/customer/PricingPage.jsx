...
import { confirmCheckoutSession, createCheckoutSession } from '../../services'
...
export default function PricingPage() {
  ...
  useEffect(() => {
    ...
    async function finishCheckout() {
      ...
      const shouldConfirm = (status === 'success' || (!status && sessionId)) && sessionId && user
      if (shouldConfirm) {
            ...
            <table className="min-w-full text-left text-sm">
              ...
              <tbody>
                ...
                {Array.from(
                  ...
                  <tr
                    key={featureLabel}
                    className="border-b border-border last:border-0 hover:bg-canvas/30"
                  >

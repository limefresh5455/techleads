          ...
          <div className="bg-card w-full max-w-2xl rounded-xl border border-border shadow-2xl flex flex-col max-h-[90vh]">
            ...
            <div className="p-6 overflow-y-auto space-y-6">
              <div className="grid grid-cols-2 gap-4 bg-canvas/50 p-4 rounded-lg border border-border">
                <div>
                  <label className="text-xs font-semibold text-ink/60 uppercase tracking-wider block mb-1">
                    Name
                  </label>
                ...
                <div>
                  ...
                  {selectedItem.company_website ? (
                    <a
                      href={
                        selectedItem.company_website.startsWith('http')
                          ? selectedItem.company_website
                          : `https://${selectedItem.company_website}`
                      }
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-1 text-brand hover:underline break-all"
                    >
                      {selectedItem.company_website}
              ...
              <div>
                <label className="text-xs font-semibold text-ink/60 uppercase tracking-wider block mb-2">
                  Message
                </label>

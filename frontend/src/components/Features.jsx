    ...
    <section id="features" className="bg-surface py-16 md:py-20">
      <div className="mx-auto max-w-7xl px-4 lg:px-6">
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-3">
          {features.map((f) => (
            <div key={f.id} className="card-hover rounded-2xl border border-border bg-card p-6">
        ...
        <div
          id="tools"
          className="mt-12 flex flex-col items-start justify-between gap-4 rounded-2xl border border-border bg-inverse p-6 text-white md:flex-row md:items-center md:p-8"
        >
          <div className="flex items-start gap-4">
            <div className="grid h-12 w-12 place-items-center rounded-xl bg-card/10">
          ...
          <Link
            ...
            className="shrink-0 rounded-xl bg-brand px-5 py-3 text-sm font-semibold text-on-brand shadow-sm shadow-brand/30 transition hover:-translate-y-0.5 hover:bg-brand-dark"
          >

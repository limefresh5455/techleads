...
export default function PageHero({ title, subtitle, ctaLabel = 'Get Started', ctaTo = '/get-started' }) {
  return (
    <section className="relative overflow-hidden border-b border-border bg-gradient-to-b from-[#fffbeb] to-white py-14 md:py-20">
      ...
      <div className="relative mx-auto max-w-7xl px-4 text-center lg:px-6">
        ...
        <Link
          to={ctaTo}
          className="reveal reveal-delay-2 mt-8 inline-flex rounded-xl bg-brand px-6 py-3 text-sm font-semibold text-ink shadow-md shadow-brand/30 transition hover:-translate-y-0.5 hover:bg-brand-dark"
        >
          {ctaLabel}
        </Link>
      </div>
